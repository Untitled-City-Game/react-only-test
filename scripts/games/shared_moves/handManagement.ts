...
import { AllChallengeData, Challenge, ConnectFourGameState, MatchTeamColor, TeamData } from "@/scripts/types";
...
export function discardChallenge(
	{ G, playerID }: { G: ConnectFourGameState; log: LogAPI; playerID: string; },
	challenge: string
) {
...
export function drawChallenge({ G, playerID }: { G: ConnectFourGameState; playerID: string; }, teamData: TeamData) {
